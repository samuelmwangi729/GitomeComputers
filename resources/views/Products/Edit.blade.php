       ...
       <form method="post" action="{{ route('products.store') }}" enctype="multipart/form-data">
        @csrf
           <div class="col-sm-6">
               <div class="form-group @error('ProductName') bad @enderror">
                   ...
                   <input type="text" name="ProductName" id="" class="form-control" value="{{ $product->ProductName }}">
                   @error('ProductName') 
           ...
           <div class="col-sm-6">
            <div class="form-group @error('ProductText') bad @enderror">
                ...
                <input type="text" name="ProductText" id="" class="form-control" value="{{ $product->ProductText }}">
                @error('ProductText') 
                <span style="color:red">
                    {{ $message }}
                </span>
        ...
        <div class="col-sm-6">
            <div class="form-group @error('ProductCategory') bad @enderror">
               ...
               <select class="form-control" name="ProductCategory">
                   ...
                   <option value="{{ $category->CategoryName }}" @if($category->CategoryName  == $product->ProductCategory) selected @endif >{{ $category->CategoryName }}</option>
                   @endforeach
               </select>
        ...
        <div class="col-sm-6">
            <div class="form-group @error('ProductName') bad @enderror">
               ...
               <select class="form-control" name="ProductBrand">
                   ...
                   <option value="{{ $brand->BrandName }}" @if($brand->BrandName == $product->ProductBrand) selected @endif>{{ $brand->BrandName }}</option>
                   @endforeach
               </select>
               @error('ProductBrand') 
               <span style="color:red">
        ...
        <div class="col-sm-6">
            <div class="form-group  @error('SellingPrice') bad @enderror">
              ...
              <input type="number" name="SellingPrice" id="" class="form-control" value="{{ $product->SellingPrice }}">
              @error('SellingPrice') 
                <span style="color:red">
                    {{ $message }}
                </span>
        ...
        <div class="col-sm-6">
            <div class="form-group @error('ProductCount') bad @enderror">
              ...
              <input type="number" name="ProductCount" id="" class="form-control" value="{{ $product->ProductCount }}">
              @error('ProductCount') 
                <span style="color:red">
                    {{ $message }}
                </span>
        ...
        <div class="col-sm-6">
            <div class="form-group @error('ProductImage') bad @enderror">
              ...
              <input type="file" name="ProductImage" id="" class="form-control" chosen="{{ $product->ProductImage }}">
              @error('ProductImage') 
                <span style="color:red">
                    {{ $message }}
                </span>
