      ...
      <div class="col-md-12">
        <div class="full">
          <div class="main_heading text_align_center">
            ...
            <p class="large">We  Offer Fastest Repair Services with Most Fair Prices of All!</p>
          </div>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
        <div class="full text_align_center margin_bottom_30">
          ...
          <p>Information Loss is just brief and we demonstrate it consistently with the most elevated Hard Drive Recovery Success every day.</p>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
        <div class="full text_align_center margin_bottom_30">
          ...
          <p>We Get All your Systems up  and Running. Try Our Services Today. Don't let the failing device intefere with your job</p>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
        <div class="full text_align_center margin_bottom_30">
          ...
          <p>As mobile industry grow, we also help serve our customers in any issue involving their mobile devices Including their Security</p>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
        <div class="full text_align_center margin_bottom_30 margin_0">
          ...
          <p>No Network,No Jobs. Let Us help you solve this. We can Do it for you and also troubleshoot Any Network related Issues</p>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 margin_bottom_50">
            ...
            <div class="text_align_right">
              <p class="counter-heading text_align_right">Customers</p>
            </div>
            <h5 class="counter-count">1039</h5>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 margin_bottom_50">
            <div class="text_align_right"><i class="fa fa-laptop"></i></div>
            <div class="text_align_right">
              <p class="counter-heading text_align_right">Laptops Repaired</p>
            </div>
            <h5 class="counter-count">530</h5>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 margin_bottom_50">
            <div class="text_align_right"><i class="fa fa-desktop"></i></div>
            <div class="text_align_right">
              <p class="counter-heading">Desktop Computer Repaired</p>
            </div>
            <h5 class="counter-count">509</h5>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 margin_bottom_50">
            <div class="text_align_right"><i class="fa fa-windows"></i></div>
            <div class="text_align_right">
              <p class="counter-heading">Operating Systems  Installed</p>
            </div>
