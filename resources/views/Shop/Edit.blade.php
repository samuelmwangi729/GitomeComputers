...
<div class="row">
    ...
    <div class="x_panel">
        ...
        <div class="row">
            <form method="post" action="{{ route('shops.update',[$slider->id]) }}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                ...
                <div class="col-sm-6 @error('Headline') bad @enderror">
                  <div class="form-group">
                    ...
                    <input type="text" name="Headline" id="" class="form-control" value="{{ $slider->Headline }}">
                    @error('Headline') 
                    <span class="text-danger">
                        {{ $message }}
                    </span>
                ...
                <div class="col-sm-6 @error('Text') bad @enderror">
                    <div class="form-group">
                        ...
                        <input type="text" name="Text" id="" class="form-control" value="{{ $slider->Text }}">
                        @error('Text') 
                        <span class="text-danger">
                            {{ $message }}
                        </span>
                ...
                <div class="col-sm-6 @error('LinkText') bad @enderror">
                    <div class="form-group">
                        ...
                        <input type="text" name="LinkText" id="" class="form-control" placeholder="Eg.Shop Now" value="{{ $slider->LinkText }}">
                        @error('LinkText') 
                        <span class="text-danger">
                            {{ $message }}
                        </span>
                ...
                <div class="col-sm-6 @error('Link') bad @enderror">
                    <div class="form-group">
                        ...
                        <input type="text" name="Link" id="" class="form-control" value="{{ $slider->Link }}">
                        @error('Link') 
                        <span class="text-danger">
                            {{ $message }}
                        </span>
               ...
               <div class="col-sm-6">
                <button class="btn btn-success fa fa-send" style="margin-top:25px">Update Slider</button>
